...
import unittest
from devicemanagement.device_cosume import consume, _sync_partner_device_add, _sync_gaia_device_add, _sync_gaia_device_deleted
...
def test_add_partner_device():
    layer = Layer(Env.DEV)
    device_add_message = {'deviceId': '2030838',
                          'reachability': {'deviceId': '2030838', 'value': 'online', 'updated_at': 1593672252675},
                          'deviceInfo': {'deviceId': '2030838', 'nickName': '空调333', 'tslId': 'tsl-id-01-temp02',
                          ...
                          'properties': {'deviceId': '2030838', 'capabilities': {}}, 'partnerId': 'oversea_iot',
